...
public class ImgPanel extends Panel{
  ...
  int  angle = 0; 
     for(int i = 0; i < n; i++){ 
     g.setColor(col[i]);
     g.fillArc(Img.getWidth(this)/2-550, Img.getHeight(this)/2-300/2, 400, 400, angle, (int)winkel[i]);
     g.fillRect(600+i*150, Img.getHeight(this)/n + (450-(int)h[i]), 100, (int)h[i]);   //Img.getWidth(this)/n
